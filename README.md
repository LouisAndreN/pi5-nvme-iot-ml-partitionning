...
| ├─ lv-containers        | 80 GB    | xfs    | /var/lib/containers                 | Docker (HA, MQTT, Grafana, Prometheus – except DB)          |
...
| nvme0n1p5               | 838 GB   | LUKS   | cryptdata (encrypted)               | LUKS 暗号化領域                                                                     |
| ├─ vg-main              | 838 GB   | LVM    | Volume Group                        | 上の LVM ボリュームグループ                                                       |
